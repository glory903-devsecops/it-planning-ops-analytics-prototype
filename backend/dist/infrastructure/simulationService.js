...
class SimulationService {
    ...
    initialize(salesCount, memberCount) {
    ...
    generateMembershipActivity(count) {
        const events = ['Open', 'Search', 'OrderStart', 'Payment_Completed'];
        const now = new Date();
        for (let i = 0; i < count; i++) {
    ...
    getSales() { return this.salesHistory; }
    getInventory() { return this.inventorySnapshots; }
    getNetwork() { return this.networkEvents; }
    getMembership() { return this.membershipActivity; }
    getCompliance() { return this.complianceRecords; }
}
exports.SimulationService = SimulationService;
exports.simulationService = SimulationService.getInstance();
