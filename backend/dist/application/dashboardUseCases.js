...
exports.dashboardUseCases = exports.DashboardUseCases = void 0;
const simulationService_1 = require("../infrastructure/simulationService");
class DashboardUseCases {
    getSalesDashboard() {
        return __awaiter(this, void 0, void 0, function* () {
            const rawSales = simulationService_1.simulationService.getSales();
    ...
    getStrategicDashboard() {
        return __awaiter(this, void 0, void 0, function* () {
            const sales = simulationService_1.simulationService.getSales();
            const membership = simulationService_1.simulationService.getMembership();
            const compliance = simulationService_1.simulationService.getCompliance();
            const salesByStore = {};
            sales.forEach(s => {
                salesByStore[s.store_id] = (salesByStore[s.store_id] || 0) + s.net_sales;
            });
            const appTrafficByStore = {};
            membership.forEach(m => {
                if (m.store_id) {
                    appTrafficByStore[m.store_id] = (appTrafficByStore[m.store_id] || 0) + 1;
                }
            });
            const insights = compliance.map(c => {
                ...
                const healthScore = Math.round((salesScore * 0.4) +
    ...
    getLogisticsDashboard() {
        return __awaiter(this, void 0, void 0, function* () {
            const snapshots = simulationService_1.simulationService.getInventory();
    ...
    getNetworkDashboard() {
        return __awaiter(this, void 0, void 0, function* () {
            const events = simulationService_1.simulationService.getNetwork();
    ...
    getCSVData(filters) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = this.filterSales(simulationService_1.simulationService.getSales(), filters);
            const headers = [
    ...
    createKpi(params) {
        ...
        return {
            ...
            trend: params.trend,
            trendDirection: (_a = params.trendDirection) !== null && _a !== void 0 ? _a : 'neutral',
            confidenceScore: (_b = params.confidenceScore) !== null && _b !== void 0 ? _b : 90,
    ...
    getRecentPayments(data, limit = 30) {
        return data
    ...
    filterSales(data, filters) {
        return data.filter(sales => {
            if (filters.store && sales.store_name !== filters.store)
                return false;
            if (filters.item && sales.item_name !== filters.item)
                return false;
            return true;
        });
    }
...
exports.dashboardUseCases = new DashboardUseCases();
